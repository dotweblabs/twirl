...
import com.pastekit.twist.annotations.*;
import com.pastekit.twist.common.ObjectNotFoundException;
import com.pastekit.twist.gae.GaeMarshaller;
import com.pastekit.twist.gae.GaeUnmarshaller;
import com.pastekit.twist.object.KeyStructure;
import com.pastekit.twist.serializer.ObjectSerializer;
import com.pastekit.twist.types.Find;
import com.pastekit.twist.types.FindOne;
import com.pastekit.twist.types.Update;
import com.pastekit.twist.util.AnnotationUtil;
import com.pastekit.twist.util.StringHelper;
import com.pastekit.twist.wrappers.PrimitiveWrapper;
import com.pastekit.twist.annotations.*;
import com.pastekit.twist.common.ObjectNotFoundException;
import com.pastekit.twist.gae.GaeMarshaller;
import com.pastekit.twist.gae.GaeUnmarshaller;
...
import com.pastekit.twist.types.Find;
import com.pastekit.twist.types.FindOne;
import com.pastekit.twist.types.Function;
import com.pastekit.twist.types.Update;
import com.pastekit.twist.util.AnnotationUtil;
import com.pastekit.twist.util.StringHelper;
import com.pastekit.twist.wrappers.PrimitiveWrapper;
...
public class GaeObjectStore implements ObjectStore {
    ...
    public static Class<com.pastekit.twist.annotations.Entity> entity(){
        return com.pastekit.twist.annotations.Entity.class;
    }
    ...
    public void register(Class<?> clazz){
        ...
        if(annotations.isEmpty()){
            ...
            for (Annotation annotation : annotations) {
                com.pastekit.twist.annotations.Entity entityAnnotation = null;
                if(annotation instanceof com.pastekit.twist.annotations.Entity){
                    entityAnnotation = (com.pastekit.twist.annotations.Entity)annotation;
                }
