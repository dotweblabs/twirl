...
import com.hunchee.twist.common.ObjectNotFoundException;
import com.hunchee.twist.gae.GaeMarshaller;
import com.hunchee.twist.gae.GaeUnmarshaller;
import com.hunchee.twist.object.KeyStructure;
import com.hunchee.twist.serializer.ObjectSerializer;
import com.hunchee.twist.types.Find;
import com.hunchee.twist.types.Update;
import com.hunchee.twist.util.AnnotationUtil;
import com.hunchee.twist.util.StringHelper;
import com.hunchee.twist.wrappers.PrimitiveWrapper;
...
public class GaeObjectStore implements ObjectStore {
    ...
    public static Class<com.hunchee.twist.annotations.Entity> entity(){
        return com.hunchee.twist.annotations.Entity.class;
    }
    ...
    public void register(Class<?> clazz){
        ...
        if(annotations.isEmpty()){
            ...
            for (Annotation annotation : annotations) {
                com.hunchee.twist.annotations.Entity entityAnnotation = null;
                if(annotation instanceof com.hunchee.twist.annotations.Entity){
                    entityAnnotation = (com.hunchee.twist.annotations.Entity)annotation;
                }
